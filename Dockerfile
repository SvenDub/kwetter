...
RUN asadmin start-domain domain1 \
    ...
    --property jaas-context="jdbcRealm":encoding="Base64":password-column="password":datasource-jndi="jdbc/kwetter":group-table="v_User_SecurityGroup":user-table="User":group-name-column="securityGroup_name":digestrealm-password-enc-algorithm="none":digest-algorithm="SHA-256":user-name-column="email":group-table-user-name-column="email" \
    admin \
